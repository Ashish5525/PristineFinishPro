...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      duration: "2-3 hours",
      description:
        "Complete exterior restoration that brings back your car's original shine.",
      icon: Car,
      features: [
    ...
    },
    {
      ...
      duration: "2-3 hours",
      description:
        "Deep cleaning and conditioning for your vehicle's interior.",
      icon: Home,
      features: [
    ...
    },
    {
      ...
      duration: "4-5 hours",
      description:
        "Complete interior and exterior detailing for the ultimate car care experience.",
      icon: Sparkles,
      features: [
    ...
    },
    {
      ...
      duration: "Full day",
      description:
        "Invisible protection film that shields your paint from chips and scratches.",
      icon: Shield,
      features: [
    ...
    },
    {
      ...
      duration: "2 days",
      description:
        "Advanced nano-ceramic protection that provides years of gloss and protection.",
      icon: Palette,
      features: [
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl opacity-90 mb-8">
              From basic washes to premium protection, we offer comprehensive
              car care solutions tailored to your needs and budget.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service) => {
              ...
              return (
                <Card
                  key={service.id}
                  className={`relative group hover:shadow-xl transition-all duration-300 ${service.popular ? "ring-2 ring-primary" : ""}`}
                >
                  {service.popular && (
              ...
              {[
                {
                  ...
                  title: "Inspection",
                  description:
                    "Thorough assessment of your vehicle's condition",
                },
                {
                  step: "2",
                  title: "Preparation",
                ...
                },
                {
                  step: "3",
                  title: "Detailing",
                  description: "Professional application of our services",
                },
                {
                  step: "4",
                  title: "Quality Check",
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Choose the perfect service for your car and book your appointment
            today.
          </p>
