  ...
  const services = [
    {
      ...
      description:
        "Complete wash, clay, polish, and wax to restore your car's shine",
      price: "From $150",
      features: [
        "Paint wash & dry",
        "Clay bar treatment",
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-4xl mx-auto text-center">
            <Badge
              variant="secondary"
              className="mb-6 bg-primary/20 text-primary-foreground"
            >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional automotive detailing that brings back that showroom
              shine. Expert care for your vehicle's exterior and interior.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              From basic wash to premium protection, we offer comprehensive
              detailing services for every need and budget.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                We're not just another car wash. We're passionate professionals
                who treat every vehicle with the care it deserves.
              </p>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      We use only the highest quality detailing products and
                      equipment for superior results.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Professional service that respects your schedule with
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      100% satisfaction guarantee - if you're not happy, we'll
                      make it right.
                    </p>
                  </div>
                </div>
              ...
              <div className="aspect-square bg-gradient-to-br from-primary to-accent rounded-3xl p-8 text-white">
                <div className="h-full flex flex-col justify-center items-center text-center">
                  ...
                  <p className="text-lg opacity-90">
                    Join our growing family of satisfied car owners who trust us
                    with their vehicles.
                  </p>
                </div>
              </div>
